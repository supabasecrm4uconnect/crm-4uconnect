...
export default function Login() {
  ...
  const inputCls = 'w-full pl-10 pr-3.5 py-2.5 rounded-lg border border-slate-200 bg-slate-50 text-slate-900 caret-slate-700 text-sm placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent focus:bg-white transition cursor-text'
                  ...
                  <form onSubmit={handleLogin} className="space-y-4">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        placeholder="Senha"
                        required
                        className="w-full pl-10 pr-10 py-2.5 rounded-lg border border-slate-200 bg-slate-50 text-slate-900 caret-slate-700 text-sm placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent focus:bg-white transition cursor-text"
                      />
                      <button
                        type="button"
